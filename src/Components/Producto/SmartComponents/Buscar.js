                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-md-4 col-sm-12">
                            ...
                            <button className="btn btn-danger btn-block" onClick={this.handlerLimpiarProducto}>Eliminar Producto</button>
                        </div>
                        <div className="col-md-8 col-sm-12">
                                <Tabla seleccionarElemento={this.seleccionarElemento}></Tabla>
