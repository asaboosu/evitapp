                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-md-4 col-sm-12">
                            <div className="text-center">
                                ...
                                <div className="input-group input-group-lg m-2  border border-success rounded rounded-lg mx-auto shadow shadow-lg  rounded rounded-lg " >
                                    ...
                                    <input ref="categoria" type="text" autoFocus
                                        className="form-control" value={this.props.match.params.categoria} onChange={this.handlerCambioProducto} aria-label="" aria-describedby="inputGroup-sizing-lg" />
                                </div>
                                <div className="input-group input-group-lg m-2  border border-success rounded rounded-lg mx-auto shadow shadow-lg  rounded rounded-lg " >
                                    <div className="input-group-prepend">
                            ...
                            <button className="btn btn-danger mb-2 btn-block" onClick={this.handlerLimpiarProducto}>Eliminar Producto</button>
                                ...
                                <Switch>
                                    {
                                        this.state.categorias.map(categoria => {
                                            return (<Route exact key={categoria + "Route"} path={"/producto/ver/" + this.props.match.params.categoria}>
                                                <Tabla key={categoria} seleccionarElemento={this.seleccionarElemento}></Tabla>
                                            </Route>);
...
export default withRouter(Tablas);
